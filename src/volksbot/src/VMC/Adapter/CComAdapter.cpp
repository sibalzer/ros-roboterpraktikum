...
int CComAdapter::openDevice()
{
  ...
  _hCom = CreateFile(_szDeviceName, GENERIC_READ | GENERIC_WRITE, 0, NULL, OPEN_EXISTING,
...
//}
  ...
  if (_hCom >= 0)
  {
    ...
    comSettingsNew.config_mask = RTSER_SET_BAUD | RTSER_SET_PARITY | RTSER_SET_DATA_BITS | RTSER_SET_STOP_BITS |
                                 RTSER_SET_HANDSHAKE | RTSER_SET_TIMEOUT_RX | RTSER_SET_TIMEOUT_TX |
                                 RTSER_SET_FIFO_DEPTH | RTSER_SET_TIMEOUT_EVENT | RTSER_SET_EVENT_MASK |
