...
public:
  ...
  ///  @brief constructor
  //////////////////////////////////////////////////////////////////////////////
  CError(const std::string& ErrorType) : m_sErrorType(ErrorType)
  {
    m_Timestamp.update();
  }
  ...
  CError(const std::string& ErrorType, const std::string& MethodName)
    : m_sErrorType(ErrorType), m_sMethodName(MethodName)
  {
    m_Timestamp.update();
  }
  ...
  CError(const std::string& ErrorType, const std::string& MethodName, const std::string& correspondDataName)
    : m_sErrorType(ErrorType), m_sMethodName(MethodName), m_sCorrespondDataName(correspondDataName)
  {
    m_Timestamp.update();
  }
  ...
  CError(const std::string& ErrorType, const std::string& MethodName, const CMessage& correspondMessage)
    : m_sErrorType(ErrorType), m_sMethodName(MethodName), m_correspondMessage(correspondMessage)
  {
    m_Timestamp.update();
  }
  ...
  ///  @brief constructor
  //////////////////////////////////////////////////////////////////////////////
  CError(const std::string& ErrorType, const std::string& MethodName, const std::string& ErrorString,
         const CMessage& correspondMessage)
