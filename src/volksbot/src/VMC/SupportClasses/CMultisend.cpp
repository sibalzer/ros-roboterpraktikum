...
//////////////////////////////////////////////////////////////////////////////
bool CMultisend::Init(CTranslationLayer* Trans, BYTE* pNextRequestCommand, const BYTE nCommandGroup,
                      const BYTE nCommand, const EnumDataType DataType)
{
  if (m_bInitialized)
    return false;
...
///  @returns true = OK / false = Error
//////////////////////////////////////////////////////////////////////////////
bool CMultisend::Set(const double Motor1, const double Motor2, const double Motor3, const double Motor4,
                     const double Motor5, const double Motor6, const double Motor7, const double Motor8,
                     const double Motor9, const double Motor10)
{
  if (!m_bInitialized)
  {
