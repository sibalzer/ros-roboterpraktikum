...
bool CCommunicationLayer::initDevice()
{
  ...
  // printf("CCLiD: succesfully connected!!!\n");
  return true;
}
...
//////////////////////////////////////////////////////////////////////////////
#ifdef REAL_TIME
bool CCommunicationLayer::receive(std::string& receiveString, uint64_t& timestamp)
{
#else
...
#ifdef REAL_TIME
  timestamp = m_Adapter->getTimeStamp();
#endif
  return true;
}
