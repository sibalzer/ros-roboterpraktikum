...
public:
   ...
   */
  virtual unsigned long send(char* szBuffer, unsigned long ulLength) = 0;
   ...
   */
  virtual unsigned long receive(char* szBufffer, unsigned long ulLength) = 0;
   ...
   */
  virtual void setDeviceName(char* szDeviceName) = 0;
   ...
   */
  virtual EnumAdapterType getAdapterType() = 0;
   ...
   * @return receive mode
   */
  virtual EnumReceiveMode getReceiveMode() = 0;
