...
bool CStorage::Init(CTranslationLayer* Trans, BYTE* pNextRequestCommand)
{
  ...
  VelocityInputType.Init(m_pTrans,
                         pNextRequestCommand,  // Pointer to the Translation Layer / Pointer to next Request Command
