...
///  @file CRequest.h
///  @class VMC::CRequest
///  @brief An object of this class represents a request to the VMC. It also includes the buildup of the corresponding
///  response message.
///  @author Jan Paulus
///  @version 0.1
///  @date 23.10.2006
...
public:
  ...
  CRequest(BYTE CommandGroup, BYTE Command, std::vector<CData*>& ResponseBuildup, bool ActiveSwitch = false)
    : m_CommandGroup(CommandGroup), m_Command(Command), m_ResponseBuildup(ResponseBuildup), m_bAktive(ActiveSwitch){};
