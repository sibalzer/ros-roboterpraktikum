...
set(MSG_I_FLAGS "-Ivolksbot:/home/crab/Documents/catkin_ws/src/nodes2021/volksbot/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/crab/Documents/catkin_ws/src/nodes2021/volksbot/msg/pose2d.msg" NAME_WE)
add_custom_target(_volksbot_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "volksbot" "/home/crab/Documents/catkin_ws/src/nodes2021/volksbot/msg/pose2d.msg" ""
)

get_filename_component(_filename "/home/crab/Documents/catkin_ws/src/nodes2021/volksbot/msg/ticks.msg" NAME_WE)
add_custom_target(_volksbot_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "volksbot" "/home/crab/Documents/catkin_ws/src/nodes2021/volksbot/msg/ticks.msg" "std_msgs/Header"
)

get_filename_component(_filename "/home/crab/Documents/catkin_ws/src/nodes2021/volksbot/srv/velocities.srv" NAME_WE)
add_custom_target(_volksbot_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "volksbot" "/home/crab/Documents/catkin_ws/src/nodes2021/volksbot/srv/velocities.srv" ""
)

get_filename_component(_filename "/home/crab/Documents/catkin_ws/src/nodes2021/volksbot/msg/vels.msg" NAME_WE)
add_custom_target(_volksbot_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "volksbot" "/home/crab/Documents/catkin_ws/src/nodes2021/volksbot/msg/vels.msg" ""
)
...
_generate_srv_cpp(volksbot
  "/home/crab/Documents/catkin_ws/src/nodes2021/volksbot/srv/velocities.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/volksbot
)
...
### Generating Messages
_generate_msg_nodejs(volksbot
  "/home/crab/Documents/catkin_ws/src/nodes2021/volksbot/msg/pose2d.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/volksbot
)
_generate_msg_nodejs(volksbot
  "/home/crab/Documents/catkin_ws/src/nodes2021/volksbot/msg/ticks.msg"
  "${MSG_I_FLAGS}"
...
### Generating Module File
_generate_module_nodejs(volksbot
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/volksbot
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(volksbot_generate_messages_nodejs
  DEPENDS ${ALL_GEN_OUTPUT_FILES_nodejs}
)
add_dependencies(volksbot_generate_messages volksbot_generate_messages_nodejs)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/crab/Documents/catkin_ws/src/nodes2021/volksbot/msg/pose2d.msg" NAME_WE)
add_dependencies(volksbot_generate_messages_nodejs _volksbot_generate_messages_check_deps_${_filename})
get_filename_component(_filename "/home/crab/Documents/catkin_ws/src/nodes2021/volksbot/msg/ticks.msg" NAME_WE)
add_dependencies(volksbot_generate_messages_nodejs _volksbot_generate_messages_check_deps_${_filename})
get_filename_component(_filename "/home/crab/Documents/catkin_ws/src/nodes2021/volksbot/srv/velocities.srv" NAME_WE)
add_dependencies(volksbot_generate_messages_nodejs _volksbot_generate_messages_check_deps_${_filename})
...
# target for backward compatibility
add_custom_target(volksbot_gennodejs)
add_dependencies(volksbot_gennodejs volksbot_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS volksbot_generate_messages_nodejs)
...
if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/volksbot)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/volksbot
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(volksbot_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/volksbot)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/volksbot\")")
  # install generated code
  install(
